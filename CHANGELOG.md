...
- **Settings store** (`SettingsService`, `src/services/settings.ts`): one declarative table of 43
  settings across six groups (branding, connection, limits, elevenlabs, retention,
