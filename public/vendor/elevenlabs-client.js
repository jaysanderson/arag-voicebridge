/*! Vendored @elevenlabs/client v1.14.0 — MIT (ElevenLabs). Pinned browser build (dist/lib.iife.js)
    downloaded once with bun from the corporate registry; see THIRD_PARTY_NOTICES.md.
    Do not edit. Re-vendor with: make vendor-elevenlabs */
...
export const Conversation = ElevenLabsClient.Conversation;
export const Scribe = ElevenLabsClient.Scribe;
